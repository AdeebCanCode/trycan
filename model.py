...
train_path = 'C:/Users/khana/OneDrive/Desktop/try/Datasets/train'
valid_path = 'C:/Users/khana/OneDrive/Desktop/try/Datasets/val'

vgg = VGG16(input_shape=IMAGE_SIZE + [3], weights='imagenet', include_top=False)

for layer in vgg.layers: layer.trainable = False

folders = glob('C:/Users/khana/OneDrive/Desktop/try/Datasets/train/*')
...
#Make sure you provide the same target size as initialied for the image sizetraining_set = train_datagen.flow_from_directory('Datasets/train', target_size = (224, 224), batch_size = 10, class_mode = 'categorical')
test_set = test_datagen.flow_from_directory('C:/Users/khana/OneDrive/Desktop/try/Datasets/test', target_size = (224, 224), batch_size = 10, class_mode = 'categorical')
training_set = train_datagen.flow_from_directory('C:/Users/khana/OneDrive/Desktop/try/Datasets/train', target_size = (224, 224), batch_size = 10, class_mode = 'categorical')
...
model.save('xrays.h5')
#loading model
model=load_model('xrays.h5')

#loading the image from files can be changed for testing different files
img=image.load_img('C:/Users/khana/OneDrive/Desktop/try/Datasets/test/malignant/ACL mucoid degeneration(Chondrosarcoma)_malignant.jpg',target_size=(224,224))
...
training_accuracy = r.history['accuracy'][0]
validation_accuracy = r.history['val_accuracy'][0]
